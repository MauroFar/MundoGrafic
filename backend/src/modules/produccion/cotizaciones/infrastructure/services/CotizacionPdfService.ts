/**
 * ============================================================
 * INFRASTRUCTURE SERVICE — CotizacionPdfService
 * ============================================================
 * Servicio de infraestructura para generación de PDF de cotizaciones.
 * Encapsula puppeteer + template HTML.
 * Usado por: GenerateCotizacionPdfUseCase, PreviewCotizacionPdfUseCase,
