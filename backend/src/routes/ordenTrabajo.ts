      ...
      try {
        ...
        const workflows: any = {
          offset: [
            {
              id: "preprensa",
              db_estado: "en_preprensa",
              titulo: "Pre prensa",
              color: "blue",
              aliases: ["preprensa", "pre prensa", "en preprensa", "en_preprensa"],
            },
            {
              id: "guillotinado",
              db_estado: "en_preprensa",
              titulo: "Guillotinado",
              color: "indigo",
              aliases: ["guillotinado", "guillotina"],
            },
            {
              id: "prensa",
              db_estado: "en_prensa",
              titulo: "Prensa",
              color: "purple",
              aliases: ["prensa", "impresion", "impresión", "en_prensa", "en prensa"],
            },
            {
              id: "barnizado",
              db_estado: "terminados",
              titulo: "Barnizado",
              color: "orange",
              aliases: ["barnizado"],
            },
            ...
            },
            {
              id: "terminados_mg",
              db_estado: "terminados",
              titulo: "Terminados MG",
              color: "yellow",
              aliases: ["terminados mg", "terminado mg", "terminados", "terminado"],
            },
            {
              id: "terminados_externos",
              db_estado: "terminados",
              titulo: "Terminados externos",
              color: "gray",
              aliases: ["terminados externos", "terminado externo"],
            },
            {
              id: "entregado",
              db_estado: "entregado",
