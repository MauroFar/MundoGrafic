...
export const validateOrdenTrabajo = (
  ...
  // concepto y cantidad ahora son opcionales (viven en productos_orden_offset/digital)
  // Se aceptan al top-level por compatibilidad con el frontend anterior

  // Fechas opcionales pero si se proporcionan deben ser válidas
  if (fechaCreacionStr && !fechaCreacionStr.trim()) {
    errors.push({
      field: "fecha_creacion",
      message: "La Fecha de Creación no puede estar vacía si se proporciona",
    });
  }
  ...
  if (fechaEntregaStr && !fechaEntregaStr.trim()) {
    errors.push({
      field: "fecha_entrega",
      message: "La Fecha de Entrega no puede estar vacía si se proporciona",
    });
  }
  ...
  if (telefonoStr && !telefonoStr.trim()) {
    errors.push({
      field: "telefono",
      message: "El campo Teléfono no puede estar vacío si se proporciona",
    });
  }
  ...
  if (emailStr && !emailStr.trim()) {
    errors.push({
      field: "email",
      message: "El campo Email no puede estar vacío si se proporciona",
    });
  ...
  if (materialStr && !materialStr.trim()) {
    errors.push({
      field: "material",
      message: "El campo Material no puede estar vacío si se proporciona",
    });
  }
  ...
  if (corteMaterialStr && !corteMaterialStr.trim()) {
    errors.push({
      field: "corteMaterial",
      message:
        "El campo Corte de Material no puede estar vacío si se proporciona",
    });
  }

  if (
    cantidadPliegosCompraStr &&
    (!cantidadPliegosCompraStr.trim() ||
      isNaN(Number(cantidadPliegosCompraStr)))
  ) {
    errors.push({
      field: "cantidadPliegosCompra",
      message: "La Cantidad de Pliegos de Compra debe ser un número válido",
    });
  }
  ...
  if (excesoStr && (!excesoStr.trim() || isNaN(Number(excesoStr)))) {
    errors.push({
      field: "exceso",
      message: "El Exceso debe ser un número válido",
    });
  }

  if (tamanoAbierto1Str && !tamanoAbierto1Str.trim()) {
    errors.push({
      field: "tamanoAbierto1",
      message: "El campo Tamaño Abierto no puede estar vacío si se proporciona",
    });
  }

  if (tamanoCerrado1Str && !tamanoCerrado1Str.trim()) {
    errors.push({
      field: "tamanoCerrado1",
      message: "El campo Tamaño Cerrado no puede estar vacío si se proporciona",
    });
  }
  ...
  if (impresionStr && !impresionStr.trim()) {
    errors.push({
      field: "impresion",
      message: "El campo Impresión no puede estar vacío si se proporciona",
    });
  }

  if (instruccionesImpresionStr && !instruccionesImpresionStr.trim()) {
    errors.push({
      field: "instruccionesImpresion",
      message:
        "El campo Instrucciones de Impresión no puede estar vacío si se proporciona",
    });
  }

  if (instruccionesAcabadosStr && !instruccionesAcabadosStr.trim()) {
    errors.push({
      field: "instruccionesAcabados",
      message:
        "El campo Instrucciones de Acabados no puede estar vacío si se proporciona",
    });
  }

  if (instruccionesEmpacadoStr && !instruccionesEmpacadoStr.trim()) {
    errors.push({
      field: "instruccionesEmpacado",
      message:
        "El campo Instrucciones de Empacado no puede estar vacío si se proporciona",
    });
  }

  if (prensaSeleccionadaStr && !prensaSeleccionadaStr.trim()) {
    errors.push({
      field: "prensaSeleccionada",
      message: "El campo Prensa no puede estar vacío si se proporciona",
    });
  }
  ...
  if (cantidadPliegosCompraStr && Number(cantidadPliegosCompraStr) < 0) {
    errors.push({
      field: "cantidadPliegosCompra",
      message: "La Cantidad de Pliegos de Compra no puede ser negativa",
    });
  }
  ...
  if (excesoStr && Number(excesoStr) < 0) {
    errors.push({
      field: "exceso",
      message: "El Exceso no puede ser negativo",
    });
  }
...
export const validateOrdenTrabajoUpdate = (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  console.log(
    "🔍 VALIDACIÓN UPDATE - Datos recibidos:",
    JSON.stringify(req.body, null, 2),
  );
  ...
  console.log(
    "🔍 VALIDACIÓN UPDATE - Detalle extraído:",
    JSON.stringify(detalle, null, 2),
  );
  ...
  if (nombre_cliente !== undefined && !nombreClienteStr.trim()) {
    errors.push({
      field: "nombre_cliente",
      message: "El campo Cliente no puede estar vacío",
    });
  }
  ...
  if (concepto !== undefined && !conceptoSrt.trim()) {
    errors.push({
      field: "concepto",
      message: "El campo Concepto no puede estar vacío",
    });
  }

  if (
    cantidad !== undefined &&
    (!cantidadStr.trim() || isNaN(Number(cantidadStr)))
  ) {
    errors.push({
      field: "cantidad",
  ...
  if (
    cantidadPliegosCompra !== undefined &&
    cantidadPliegosCompraStr.trim() &&
    isNaN(Number(cantidadPliegosCompraStr))
  ) {
    errors.push({
  ...
  if (
    cantidadPliegosCompra !== undefined &&
    cantidadPliegosCompraStr.trim() &&
    Number(cantidadPliegosCompraStr) < 0
  ) {
    errors.push({
      field: "cantidadPliegosCompra",
      message: "La Cantidad de Pliegos de Compra no puede ser negativa",
