      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div>
              ...
              <input
                placeholder="Escribir material de offset..."
                className="w-full px-2 py-1.5 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-green-500"
                value={material}
                onChange={(e) => {
